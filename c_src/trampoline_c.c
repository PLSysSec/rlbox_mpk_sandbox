...
struct rlbox_mpk_sandbox_thread_data* get_rlbox_mpk_sandbox_thread_data();

sandbox_thread_ctx** get_sandbox_current_thread_app_ctx() {
    struct rlbox_mpk_sandbox_thread_data* thread_data = get_rlbox_mpk_sandbox_thread_data();
